            ...
            <div className="row">
              <div className="col-lg-8">
                <div className="image_wrap">
                  <img src="/assets/images/about/about_image_3.webp" alt="Techco - About Image" />
                </div>
              </div>
              <div className="col-lg-4">
                <div className="image_wrap position-relative">
                  <img src="/assets/images/about/about_image_4.webp" alt="Techco - About Image" />
              ...
              <div className="row">
                  ...
                  <div className="funfact_block">
                    ...
                    <div className="funfact_content">
                      <div className="counter_value">
                        <span className="odometer" data-count="25">0</span>
                        <span>+</span>
                      </div>
                ...
                <div className="col-md-6">
                  <div className="funfact_block">
                    ...
                    <div className="funfact_content">
                      <div className="counter_value">
                        <span className="odometer" data-count="280">0</span>
                        <span>+</span>
                      </div>
                ...
                <div className="col-md-6">
                  <div className="funfact_block">
                    ...
                    <div className="funfact_content">
                      <div className="counter_value">
                        <span className="odometer" data-count="5.6">0</span>
                        <span>K+</span>
                      </div>
