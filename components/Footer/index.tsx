  ...
  return (
    ...
    >
      <div className="decoration_item shape_image_1">
        <Image src="/assets/images/shapes/shape_space_2.svg" alt="Techco Shape" width={100} height={100} />
      </div>
              ...
              <div className="footer_widget pe-lg-3">
                ...
                <form className="footer_newslatter_2" action="#">
                  <label htmlFor="footer_mail_input">
                    <Image src="/assets/images/icons/icon_mail_2.svg" alt="Mail SVG Icon" width={18} height={16} />
                  </label>
